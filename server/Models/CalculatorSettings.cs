...
public class CalculatorSettings
{
    ...
    ///
    /// 0 — казахстанский график: деньги уходят в первую среду после конца
    /// периода, в котором Ozon выставил документ на выплату. Сверено с кабинетом.
    /// Для российского кабинета задержка 3 недели, поэтому это настройка.
    /// </summary>
    public int PayoutDelayWeeks { get; set; }
